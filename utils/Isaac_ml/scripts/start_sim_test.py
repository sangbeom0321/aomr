...
settings.set("exts/omni.kit.remote.websocket/autoStart", True)   # Isaac Sim 시작 시 자동으로 WebSocket 시작
settings.set("/app/window/drawMouse", True)  # 마우스 포인터 표시 여부 (원격 스트리밍 시 유용)
...
class StartSim(Node):
    def __init__(self) -> None:
        ...
        package_share_directory = "/root/ssd1/robotics/isaac_sim_sources/src/Isaac_ml"
